#!/usr/bin/env python3
"""
PyVectorDB Quickstart Guide

This example demonstrates how to use PyVectorDB for semantic search and
document retrieval, similar to ChromaDB.

Installation:
    pip install pyvectordb[local]  # For local embeddings (no API key needed)
    # or
    pip install pyvectordb[openai]  # For OpenAI embeddings
...
def basic_usage():
    ...
    client = pyvectordb.Client(path="./quickstart_db")
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("  PyVectorDB Quickstart Examples")
    print("=" * 60 + "\n")
